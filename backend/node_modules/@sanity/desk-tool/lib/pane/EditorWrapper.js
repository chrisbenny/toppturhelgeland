...
class EditorWrapper extends _react.default.Component {
  constructor(..._args) {
    var _this;
  ...
  isLiveEditEnabled() {
    const selectedSchemaType = _schema.default.get(this.props.typeName);
  ...
  renderDeleted() {
    ...
    }, _react.default.createElement("h3", null, "This document just got deleted"), _react.default.createElement("p", null, "You can undo deleting it until you close this window/tab"), _react.default.createElement(_default.default, {
  ...
  render() {
    ...
    const _this$state5 = this.state,
          ...
          markers = _this$state5.markers,
          isCreatingDraft = _this$state5.isCreatingDraft,
          isUnpublishing = _this$state5.isUnpublishing,
          transactionResult = _this$state5.transactionResult,
          isPublishing = _this$state5.isPublishing,
          isSaving = _this$state5.isSaving,
          validationPending = _this$state5.validationPending,
          isReconnecting = _this$state5.isReconnecting;
    ...
    return _react.default.createElement(_Editor.default, {
      ...
      type: _schema.default.get(typeName),
...
_defineProperty(EditorWrapper, "propTypes", {
  documentId: _propTypes.default.string.isRequired,
  typeName: _propTypes.default.string.isRequired
});