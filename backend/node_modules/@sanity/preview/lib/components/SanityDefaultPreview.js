...
class SanityDefaultPreview extends _react.default.PureComponent {
  ...
  render() {
    const _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["layout"]);

    let PreviewComponent = previewComponentMap.hasOwnProperty(layout) ? previewComponentMap[layout] : previewComponentMap.default; // TODO: Bjoerge: Check for image type with "is()"
