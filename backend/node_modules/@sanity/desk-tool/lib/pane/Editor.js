...
var _default3 = _interopRequireDefault(require("part:@sanity/components/menus/default"));
...
var _default4 = _interopRequireDefault(require("part:@sanity/components/panes/default"));
...
var _default5 = _interopRequireDefault(require("part:@sanity/components/snackbar/default"));
...
var _default = (0, _router.withRouterHOC)((_temp = _class = class Editor extends _react.default.PureComponent {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "handleCreateCopy", () => {
      ...
      _document.default.create((0, _draftUtils.newDraftFrom)((0, _copyDocument.default)(draft || published))).subscribe(copied => {
    ...
    _defineProperty(this, "handleMenuClick", item => {
    ...
    _defineProperty(this, "renderFunctions", () => {
  ...
  render() {
    ...
    }), isReconnecting && _react.default.createElement(_default5.default, {
      kind: "warning"
    }, _react.default.createElement(_warningIcon.default, null), " Connection lost. Reconnecting\u2026"), didPublish && _react.default.createElement(_default5.default, {
      kind: "success",
      timeout: 4
    ...
    }))), transactionResult && transactionResult.type === 'error' && _react.default.createElement(_default5.default, {
      kind: "danger",
      action: {
        title: 'Ok, got it'
      },
