...
var _renderFunctions = _interopRequireDefault(require("./styles/renderFunctions.css"));
...
const renderFunctions = isCollapsed => {
  return _react.default.createElement("div", {
    className: _renderFunctions.default.root
  }, _react.default.createElement(_default3.default, {
    kind: "simple",
    icon: _plusIcon.default,
    color: "primary",
    title: "Add",
    className: _renderFunctions.default.button
  }), _react.default.createElement(_default3.default, {
    kind: "simple",
